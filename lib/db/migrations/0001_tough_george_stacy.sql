...
CREATE TABLE IF NOT EXISTS "GoogleToken" (
	...
	CONSTRAINT "GoogleToken_userId_unique" UNIQUE("userId")
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "GoogleToken" ADD CONSTRAINT "GoogleToken_userId_User_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
